...
- As 137 skills em `third-party/installed-skills/` podem ser carregadas sob demanda após leitura integral do `SKILL.md` selecionado.
...
A exceção é `third-party/installed-skills/`, que contém pacotes de instrução e uma skill com scripts revisados, todos importados segundo a política descrita em seu README. Essa disponibilidade não concede permissão para executar scripts, usar ferramentas, acessar rede ou credenciais nem realizar ações externas.
